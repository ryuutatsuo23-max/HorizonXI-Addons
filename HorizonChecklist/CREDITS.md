...
This Ashita v4 foundation is an independently written implementation. No XIchecklist Lua implementation code is included. The 19 Bastok quest indices were cross-checked against XIchecklist's sourced quest ordering and are explicitly attributed as data facts. At the time this foundation was prepared, the upstream repository did not contain a conventional license file; its README included informal permission to use, share, and edit the project. This project therefore keeps the inspiration and data cross-check explicit while licensing only its newly written implementation under MIT.
...
The nine-catalog magic roster is sourced from the linked HorizonXI Wiki category, job-list, and individual entry pages. Numeric spell IDs, skill classifications, learnable flags, and level-cap filtering were cross-checked against [Windower/Resources](https://github.com/Windower/Resources); no Windower implementation code is bundled.
